		...
		<div class="introduce" {...effect}>
			...
			<div class="interest">
				...
				<ul style={{ width: 'auto', margin: '0 auto' }}>
					<li>Algorithm	<small>(그 중에서도 그래프를 좋아합니다.)</small></li>
					<li>AI with ML	<small>(Computer Vision을 관심있게 공부중입니다)</small></li>
					<li>Web develop <small>(<del>군대에서 할 수 있어서...</del>)</small></li>
				</ul>
			</div>
		</div>
	);
